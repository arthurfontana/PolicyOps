# Sessão 30 — Vínculo DB ↔ rascunhos e publicação com vigência

**Modelo:** `Opus` · **Depende de:** S29 · **Épico/Marco:** Governança (M8)
...
> Você está implementando a Sessão 30 do PolicyOps — o vínculo entre itens de DB e rascunhos, e a
...
>
> ### Estado atual
> S29 entregou o DB completo até `APPROVED`, sem vínculo com versões. Rascunhos de componente
> (S26/S27) e de matriz (mecanismo original) existem e publicam individualmente. `import/apply`
...
>    campo + diff de `spec` por bloco (S28) + `CompareView` existente para item MATRIX.
>
> ### Testes
...
> pergunta 4. E2E estendendo o da S29 até PUBLISHED e conferindo a timeline dos componentes.
>
> ### Critérios de aceite
...
>
> ### Fora do escopo
> Release (S31 — publicar em lote reutiliza o que esta sessão entrega), pacote (S32), fotografia
> completa (S33).
>
...
> `docs/08-camada-de-comandos.md`, `docs/13-decisoes.md`, linha da S30 em `docs/09`.
>
> ### Regras transversais
