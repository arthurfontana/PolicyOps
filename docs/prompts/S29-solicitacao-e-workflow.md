# Sessão 29 — Solicitação de Alteração (DB) e workflow

**Modelo:** `Sonnet` · **Depende de:** S27, S28 · **Épico/Marco:** Governança (M8)

> **Por que Sonnet:** a máquina de estados, as validações e os comandos vieram prontos da S26; o
> editor rico, da S28. Esta sessão transcreve o grafo e os formulários de `docs/14` §3.3–§5 em
> telas — CRUD e composição, sem invariante nova.

## Prompt

> Você está implementando a Sessão 29 do PolicyOps — o Diário de Bordo como Solicitação de
...
>
> ### Estado atual
> S26: `ChangeRequest`, comandos de transição/aprovação e erros E-GOV testados. S27: árvore de
> componentes com versão vigente consultável. S28: `RichDocEditor` pronto para reuso. Nenhuma
> tela de DB existe.
>
> ### Objetivo
...
>    atual × proposto por item (texto a texto nesta sessão; diff rico é a S30), decisão com
...
>
> ### Fora do escopo
> Vincular rascunhos e publicar (S30 — o botão existe desabilitado com tooltip), release (S31),
> pacote (S32).
>
...
> incorporadas ao texto), `docs/13-decisoes.md`, linha da S29 em `docs/09`.
>
> ### Regras transversais
