...
>    leitura ("editor na S34") — não implemente o editor.
...
>
> ### Fora do escopo
> Editor rico (S34), DB/workflow (S35+), fotografia histórica (S39), import (S40).
>
...
> houver decisão nova, linha da S33 em `docs/09`.
>
> ### Regras transversais
