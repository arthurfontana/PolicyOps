...
| 32b ✅ | DB, release e workflow (núcleo) | **Opus** | ✅ **Entregue** — comandos de `ChangeRequest`/`Release` com inverso, grafo de 12 estados (`PUBLISHED` inalcançável por transição), aprovações que não publicam, vínculo com release e composição estática, **I30–I31** — 100% testado, sem tela | 32a |
