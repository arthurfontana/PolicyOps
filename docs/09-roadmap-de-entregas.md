...
| 43 🔮 | Vigência: a política inteira na data | **Opus** | A tela de Vigência ganha a aba Estrutura (regras, listas, variáveis e matrizes na data, em somente leitura, com "Abrir no editor (hoje)") e o modo fotografia sai da árvore (docs/07 §10, §20; DEC-UX-004) | 42 |
