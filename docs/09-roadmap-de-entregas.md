...
40 sessões incrementais — as 17 do MVP, 18–20 pós-MVP (biblioteca de variáveis), 21–25 do épico Carga, 26–31 do épico **Plataforma** (`14-plataforma-local.md`) e 32–40 do épico **Governança de Alterações** (`14-governanca-de-alteracoes.md`, 🚧 em andamento — 32a/32b/33a/33b/34/35/36/37/38/40 ✅ entregues, 39 🔮 planejada; a 32 foi dividida em **32a**/**32b** e a 33, em **33a**/**33b** — DEC-GOV-010 e DEC-GOV-012). Cada uma termina com algo que roda, testado, commitado, e com `dist/PolicyOps.html` atualizado.
...
| **5 — Governança** 🔮 | 34 ✅ → 32b ✅ → 35 ✅ → 36 ✅ → 37 ✅/38 ✅ → 39 | Editor rico, Diário de Bordo, publicação com vigência, release, pacote e fotografia histórica (32b–38 já entregues — ver linhas próprias acima; falta só a 39) |
