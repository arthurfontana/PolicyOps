...
| 41 🔮 | Shell: navegação e barra de ferramentas | **Opus** | A árvore da política é a barra lateral (todos os níveis, largura arrastável 248–480px) e as ações da tela vivem numa barra de ferramentas contextual; o painel de 360px deixa de existir (docs/07 §2, §2.1, §17.1; DEC-UX-001/003/005) | 33b, 40 |
