...
| 42 🔮 | Página do componente no centro | **Sonnet** | Regra, seção e lista se editam em coluna de até 960px no centro — identidade, payload, especificação e vigência na mesma rolagem, com barra de ações grudenta; o inspector direito passa a ser exclusivo de seleção (docs/07 §6, §17.5; DEC-UX-002) | 41 |
