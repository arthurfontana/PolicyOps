...
| Limite em faixa na célula (mín/máx, alternativa ao valor único de catálogo — S45 planejada) | `docs/03-modelo-do-documento.md` §6.2 | `src/core/document/`, `src/components/inspector/`, `src/core/import/` |
