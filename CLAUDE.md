...
| Governança de alterações (DB, workflow, release, carga por recorte — épico GOV, S32b ✅, S40 ✅, S35 ✅, S36–39 🚧) | `docs/14-governanca-de-alteracoes.md` | `src/core/document/{change-requests,cr-workflow,releases}.ts`, `src/core/import/markdown-*.ts`, `src/components/change-requests/` |
