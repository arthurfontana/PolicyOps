...
- [`docs/14-governanca-de-alteracoes.md`](docs/14-governanca-de-alteracoes.md) — épico GOV (sessões 32–40, 🔮 planejado): árvore de componentes, Solicitações de Alteração (DB), releases, pacote para a fábrica.
- [`docs/13-decisoes.md`](docs/13-decisoes.md) — catálogo de decisões (o **porquê** por trás dos normativos).
- [`docs/09-roadmap-de-entregas.md`](docs/09-roadmap-de-entregas.md) e [`docs/prompts/`](docs/prompts/) — as 40 sessões de implementação, uma por vez.
