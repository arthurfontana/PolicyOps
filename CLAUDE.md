...
| Árvore da política e cadastro/versionamento de regras (S33a/S33b ✅; árvore na barra lateral + barra de ferramentas do shell — S41 ✅ em §2/§2.1/§17.1; página do componente S42 🔮 em §17.5) | `docs/07-ux-e-editor.md` §17 | `src/components/tree/`, `src/components/shell/{Toolbar,Sidebar,Shell}.tsx`, `src/components/inspector/{ComponentInspector,ComponentPayloadFields}.tsx`, `src/core/versioning/component-lifecycle.ts` |
