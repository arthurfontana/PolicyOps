...
| Governança de alterações (DB, workflow, release — épico GOV, S32b ✅, S34–40 🚧) | `docs/14-governanca-de-alteracoes.md` | `src/core/document/{change-requests,cr-workflow,releases}.ts` |
